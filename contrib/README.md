...
Contains files used to package yrmixcoind/yrmixcoin-qt
for Debian-based Linux systems. If you compile yrmixcoind/yrmixcoin-qt yourself, there are some useful files here.
